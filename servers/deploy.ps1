...
$REDISADDR = 'rServe:6479'
$DSN = "'root:rootpass@tcp(mysql:3306)/demo'"
...
ssh -i C:\Users\Eric\INFO441_PlantHelper.pem ec2-user@planthelper.eguw.me "sudo docker run -d --network planthelper --name mysql -e MYSQL_ROOT_PASSWORD=$MYSQL_ROOT_PASSWORD -e MYSQL_DATABASE=demo eguw/planthelper_db"
